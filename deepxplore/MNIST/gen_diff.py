...
for _ in range(args.seeds):
    ...
    pred1 = sess.run(model1.output, feed_dict={input_tensor: gen_img})
    pred2 = sess.run(model2.output, feed_dict={input_tensor: gen_img})
    pred3 = sess.run(model3.output, feed_dict={input_tensor: gen_img})
    ...
    if not label1 == label2 == label3:
        ...
        imageio.imwrite('./generated_inputs/' + 'already_differ_' + str(label1) + '_' + str(
